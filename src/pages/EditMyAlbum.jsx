...
const EditMyAlbum = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
          ...
          await axios.put(`https://tune-tracker-backend.vercel.app/albums/${albumId}?_embed=tasks`, album);
    ...
    const getSingleAlbum = async (id) => {
        try {
            const response = await axios.get(`https://tune-tracker-backend.vercel.app/albums/${id}?_embed=tasks`);
