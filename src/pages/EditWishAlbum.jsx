...
const EditWishAlbum = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
          ...
          await axios.put(`https://tune-tracker-backend.vercel.app/wishlist/${albumId}?_embed=tasks`, album);
    ...
    const getSingleAlbum = async (id) => {
        try {
            const response = await axios.get(`https://tune-tracker-backend.vercel.app/wishlist/${id}?_embed=tasks`);
