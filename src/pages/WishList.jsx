...
export default function WishList () {
    ...
    const getAlbums = async () => {
        try {
            const response = await axios.get('https://tune-tracker-backend.vercel.app/wishlist');
    ...
    const deleteProject = async (id) => {
        try {
            await axios.delete(`https://tune-tracker-backend.vercel.app/wishlist/${id}?_embed=tasks`);
            getAlbums();
            } catch (error) {
