...
export default function MyAlbums () {
    ...
    const getAlbums = async () => {
        try {
            const response = await axios.get('https://tunetracker-backend-ppzy.onrender.com/albums');
    ...
    const deleteProject = async (id) => {
        try {
           await axios.delete(`https://tunetracker-backend-ppzy.onrender.com/albums/${id}?_embed=tasks`);
           getAlbums();
        } catch (error) {
